...
### Fecha de revisión: 26/Octubre/2023
...
## Practica de hacer un blink con la Pico W
...
class BLESimplePeripheral:
    def __init__(self, ble, name="LUZ"):
        self._ble = ble
...
### CÓDIGO DE LA LIBRERIA NECESARIA (ble_advertising.py)
```python
# Alumno: Hernandez Saenz Sara Jazmin
# No. control: 20211791
